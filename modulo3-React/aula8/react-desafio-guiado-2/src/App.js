...
export default class App extends Component {
  ...
  //componentDidMount é chamado sempe que a página é renderizada
  async componentDidMount() {
    ...
    this.setState({
      allCountries,
      filteredCountries: Object.assign([], allCountries), //'copia' allCountries para um outro objeto para manter a imutabilidade, já que as duas variáveis apontavem para o mesmo objeto
      filteredPopulation,
    });
  }
